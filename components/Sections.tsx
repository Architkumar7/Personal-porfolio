...
const experiences: ExperienceItem[] = [
  { role: 'ICAI (Institute of Chartered Accountants of India)', company: 'Chartered Accountancy', period: '2024 - Present', description: ['Cleared CA Foundation in June 2024 in the first attempt.', 'Wrote CA intermediate in May 2025 cleared group 1 and awaiting result for group 2.'] },
